...
/**
 * API tests for AgreementApi
 */
@Disabled
public class AgreementApiTest {

    private static AgreementApi api;

    
    @BeforeAll
    public static void beforeClass() {
        ApiClient apiClient = Configuration.getDefaultApiClient();
        api = new AgreementApi(apiClient);
    }
     ...
     */
    @Test
    public void createDebitForAusCanTest() throws ApiException {
        String region = null;
        String type = null;
        String planid = null;
        String overriderecurringchargeamount = null;
        api.createDebitForAusCan(region, type)
                .planid(planid)
     ...
     */
    @Test
    public void getDebitTest() throws ApiException {
