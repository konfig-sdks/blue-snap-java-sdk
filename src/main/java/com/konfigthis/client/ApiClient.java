...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://sandbox.bluesnap.com/services/2";
    ...
    public ApiClient(OkHttpClient client, Configuration configuration) {
        ...
        authentications.put("sec1", new ApiKeyAuth("header", "Authorization"));
    ...
    private void init() {
        ...
        setUserAgent("Konfig/8976-Tools/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://sandbox.bluesnap.com/services/2)
